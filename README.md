...
py -m producers.basic_producer_josiah_randleman
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.basic_producer_josiah_randleman
```
...
```shell
.venv\Scripts\activate
py -m consumers.basic_consumer_josiah_randleman
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.basic_consumer_josiah_randleman
```
